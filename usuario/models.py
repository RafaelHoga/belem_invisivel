...
class UsuarioManager(BaseUserManager):
    def create_user(self, email, nome_usuario, password=None, **extra_fields):
        ...
        # Remove os campos que o Django tenta colocar automaticamente e não existem no banco
...
class Usuario(AbstractBaseUser):  
    ...
    # NOVO CAMPO: Salva o caminho da foto na coluna 'foto_perfil' do MySQL
    ...
    @property
    def is_staff(self): return self.id_perfil == 1

    @property
    def is_superuser(self): return self.id_perfil == 1

    def has_perm(self, perm, obj=None): return self.id_perfil == 1

    def has_module_perms(self, app_label): return self.id_perfil == 1
