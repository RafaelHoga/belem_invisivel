...
urlpatterns = [
    ...
    # ROTA DE FAVORITOS (AJAX)
    path('favoritar/<int:id_ponto>/', views.alternar_favorito, name='alternar_favorito'),
    ...
    path('local/<int:id_local>/', views.detalhe_local, name='detalhe_local'),
    # Hotéis
    ...
    path('amazon-park/', views.detalhe_local, {'id_ponto': 10}, name='tela_hotel_amazon'),    path('radisson/', TemplateView.as_view(template_name='hoteis/tela-hotel-radisson.html'), name='tela_hotel_radisson'),
